// PERFECT TIMING Benefits Animation
// No voiceover cutoffs - each chunk plays completely
// Based on actual audio durations

console.log('💼 Loading perfectly-timed animation...');
...
class PerfectTimingAudioManager {
    ...
    initAudio() {
        ...
        this.bgMusic.volume = 0.06; // Lower for long presentation
        ...
        console.log('✅ Perfect timing audio initialized');
    }
    ...
    async startEverything() {
        ...
        console.log('🚀 Starting perfectly-timed presentation...');
        this.isPlaying = true;
        ...
        if (window.perfectTimeline) {
            ...
            console.log('✅ Perfect timeline started');
        }
    }
...
window.addEventListener('load', () => {
    console.log('✅ Initializing perfectly-timed animation...');
    ...
    // Total duration: ~80 seconds (78.25s audio + transitions)
    ...
    timeline
        ...
        // SCENE 2: Perfect Timeline (21.53-49.18s = 27.65s)
        ...
        .from('.date-group:nth-child(1) .date, .date-group:nth-child(1) .description', {
            opacity: 0,
            y: 10,
            duration: 0.5,
            stagger: 0.2
        ...
        .from('.date-group:nth-child(1) .bonus', {
            opacity: 0,
            scale: 0.8,
            duration: 0.4
        }, 27)
        ...
        .from('.date-group:nth-child(2) .date, .date-group:nth-child(2) .description', {
            opacity: 0,
            y: 10,
            duration: 0.5,
            stagger: 0.2
        ...
        .from('.date-group:nth-child(2) .bonus', {
            opacity: 0,
            scale: 0.8,
            duration: 0.4
        }, 35.5)
        ...
        .from('.date-group:nth-child(3) .date, .date-group:nth-child(3) .description', {
            opacity: 0,
            y: 10,
            duration: 0.5,
            stagger: 0.2
        ...
        .from('.date-group:nth-child(3) .bonus', {
            opacity: 0,
            scale: 0.8,
            duration: 0.4
        }, 43.5)
        ...
        .set('#scene3', { opacity: 1, visibility: 'visible' }, 49.68)
        ...
        // First 3 benefits (mental health, telemedicine, wellness)
        .from('.benefit-item:nth-child(1), .benefit-item:nth-child(2), .benefit-item:nth-child(3)', {
            x: -80,
            opacity: 0,
            scale: 0.9,
            duration: 0.8,
        ...
        .from('.benefit-item:nth-child(1) .bullet, .benefit-item:nth-child(2) .bullet, .benefit-item:nth-child(3) .bullet', {
            scale: 0,
        ...
        .from('.benefit-item:nth-child(1) .value, .benefit-item:nth-child(2) .value, .benefit-item:nth-child(3) .value', {
            x: 50,
            opacity: 0,
            scale: 0,
            duration: 0.5,
        ...
        .from('.benefit-item:nth-child(4), .benefit-item:nth-child(5)', {
            x: -80,
            opacity: 0,
            scale: 0.9,
            duration: 0.8,
        ...
        .from('.benefit-item:nth-child(4) .bullet, .benefit-item:nth-child(5) .bullet', {
            scale: 0,
            rotation: 'random(-180, 180)',
            duration: 0.4,
            stagger: 0.2,
        ...
        .from('.benefit-item:nth-child(4) .value, .benefit-item:nth-child(5) .value', {
            x: 50,
            opacity: 0,
            scale: 0,
            duration: 0.5,
    ...
    console.log('✅ Perfect timing animation ready!');
    console.log('🎬 Total duration: ~80 seconds');
    console.log('🎵 No voiceover cutoffs - each chunk plays completely');
});

console.log('✅ Perfect timing animation loaded');