// CORPORATE CLEAN WORKING - Minimalist corporate styling with working animations
console.log('💼 Loading corporate clean working animation...');

window.addEventListener('load', () => {
    console.log('✅ Creating minimalist corporate styling with working animations...');
    
    // Clean corporate styling
    const corporateStyle = document.createElement('style');
    corporateStyle.textContent = `
        /* Clean Corporate Text Visibility */
        .date {
            opacity: 1 !important;
    ...
    `;
    document.head.appendChild(corporateStyle);
    
    // Continuously ensure text visibility
    ...
    // Maintain visibility every 200ms
    setInterval(maintainVisibility, 200);
    maintainVisibility();
    
    console.log('✅ Corporate clean styling applied with guaranteed text visibility');
});
...
class PerfectTimingAudioManager {
    ...
    initAudio() {
        ...
        console.log('✅ Corporate clean audio initialized');
    }
    ...
    async startEverything() {
        ...
        console.log('🚀 Starting corporate clean presentation...');
        this.isPlaying = true;
        ...
        if (window.perfectTimeline) {
            ...
            console.log('✅ Corporate clean timeline started');
        }
    }
...
// Main animation with corporate clean styling
window.addEventListener('load', () => {
    console.log('✅ Initializing corporate clean working animation...');
    ...
    timeline
        ...
        // SCENE 2: CORPORATE CLEAN TIMELINE (21.53-49.18s)
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: Timeline intro - CORPORATE CLEAN');
        }, null, 21.53)
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: January VO - CORPORATE CLEAN');
        }, null, 25.40)
        
        // January - smooth clean entrance
        .from(dateGroups[0], {
            x: -60,
            scale: 0.9,
            duration: 1.2,
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: March VO - CORPORATE CLEAN');
        }, null, 33.87)
        
        // March - smooth clean entrance
        .from(dateGroups[1], {
            x: -60,
            scale: 0.9,
            duration: 1.2,
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: December VO - CORPORATE CLEAN');
        }, null, 41.89)
        
        // December - smooth clean entrance
        .from(dateGroups[2], {
            x: -60,
            scale: 0.9,
            duration: 1.2,
        ...
        // SCENE 3: CORPORATE CLEAN BENEFITS (49.68-78.25s)
        .set('#scene3', { 
            opacity: 1, 
            visibility: 'visible',
            display: 'block' 
        ...
        .call(() => {
            ...
            console.log('🎯 Starting Scene 3 - CORPORATE CLEAN');
        }, null, 49.68)
        ...
        .call(() => {
            ...
            console.log('🎯 Animating benefits - CORPORATE CLEAN');
        }, null, 54.96)
        
        // First 3 benefits - smooth clean entrance
        ...
        .call(() => {
            ...
            console.log('🎯 HSA benefits - CORPORATE CLEAN');
        }, null, 64.50)
        
        // HSA and fertility benefits - smooth clean entrance
        ...
        .call(() => {
            ...
            console.log('🎯 Final celebration - CORPORATE CLEAN');
        }, null, 72.37)
        
        // Final celebration - subtle clean animation
    ...
    console.log('✅ Corporate clean working animation ready!');
    console.log('🎬 Minimalist corporate design with guaranteed text visibility!');
});

console.log('✅ Corporate clean working animation loaded');