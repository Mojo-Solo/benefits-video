// SCENE 2 FIX - Perfect Timing Benefits Animation
// Fixed Scene 2 animations with proper selectors

console.log('💼 Loading Scene 2 fixed animation...');
...
class PerfectTimingAudioManager {
    ...
    async startEverything() {
        ...
        console.log('🚀 Starting Scene 2 fixed presentation...');
        this.isPlaying = true;
...
window.addEventListener('load', () => {
    console.log('✅ Initializing Scene 2 fixed animation...');
    ...
    // Get date groups for Scene 2
    const dateGroups = document.querySelectorAll('.left-panel .date-group');
    console.log('📊 Found', dateGroups.length, 'date groups in Scene 2');
    ...
    timeline
        ...
        // SCENE 2: Fixed Timeline (21.53-49.18s = 27.65s)
        ...
        .call(() => {
            ...
            console.log('🗓️ Animating January date group');
        }, null, 25.40)
        
        // January date group - using index
        .from(dateGroups[0], {
            x: -60,
            opacity: 0,
            duration: 0.8,
            ease: 'power3.out',
            onStart: () => console.log('Starting January animation')
        }, 25.5)
        ...
        .call(() => {
            ...
            console.log('🗓️ Animating March date group');
        }, null, 33.87)
        ...
        .call(() => {
            ...
            console.log('🗓️ Animating December date group');
        }, null, 41.89)
        ...
        // First 3 benefits - using querySelectorAll
        .from('.benefit-item', {
            x: -80,
            opacity: 0,
            scale: 0.9,
        ...
        .to(document.querySelectorAll('.benefit-item')[3], {
            scale: 1.05,
            duration: 0.5,
            yoyo: true,
            repeat: 1
