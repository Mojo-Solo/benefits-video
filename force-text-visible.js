// FORCE TEXT VISIBLE - Override everything to make text visible
console.log('💼 Loading force text visible...');

window.addEventListener('load', () => {
    console.log('✅ Forcing all text to be visible with CSS overrides...');
    
    // Create super strong CSS overrides that can't be overridden
    const forceStyle = document.createElement('style');
    forceStyle.textContent = `
        /* FORCE TEXT VISIBILITY - HIGHEST PRIORITY */
        ...
        /* Make sure containers don't hide text */
        .date-group, .benefit-item {
        ...
        .date[style], .description[style], .bonus[style], .text[style] {
            opacity: 1 !important;
            visibility: visible !important;
            display: block !important;
        }
    ...
    // Also set with JavaScript every 100ms to override GSAP
    const forceVisible = () => {
    ...
    // Force visibility every 100ms to override any animations
    setInterval(forceVisible, 100);
    
    // Initial force
    forceVisible();
    
    console.log('✅ Text forced visible with CSS and JavaScript overrides');
});
...
class PerfectTimingAudioManager {
    ...
    initAudio() {
        ...
        console.log('✅ Force visible audio initialized');
    }
    ...
    async startEverything() {
        ...
        console.log('🚀 Starting force visible presentation...');
        this.isPlaying = true;
        ...
        if (window.perfectTimeline) {
            ...
            console.log('✅ Force visible timeline started');
        }
    }
...
// Main animation - NO OPACITY ANIMATIONS ON TEXT
window.addEventListener('load', () => {
    console.log('✅ Initializing force visible animation...');
    ...
    timeline
        ...
        // SCENE 2: NO TEXT OPACITY ANIMATIONS (21.53-49.18s)
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: Timeline intro - NO TEXT OPACITY ANIMATIONS');
        }, null, 21.53)
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: January VO - NO TEXT OPACITY');
        }, null, 25.40)
        
        // January - ONLY animate container and positioning
        .from(dateGroups[0], {
            x: -60,
            scale: 0.8,
            duration: 1,
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: March VO - NO TEXT OPACITY');
        }, null, 33.87)
        
        // March - ONLY animate container and positioning
        .from(dateGroups[1], {
            x: -60,
            scale: 0.8,
            duration: 1,
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: December VO - NO TEXT OPACITY');
        }, null, 41.89)
        
        // December - ONLY animate container and positioning
        .from(dateGroups[2], {
            x: -60,
            scale: 0.8,
            duration: 1,
        ...
        // SCENE 3: NO TEXT OPACITY ANIMATIONS (49.68-78.25s)
        .set('#scene3', { 
            opacity: 1, 
            visibility: 'visible',
            display: 'block' 
        ...
        .call(() => {
            ...
            console.log('🎯 Starting Scene 3 - NO TEXT OPACITY ANIMATIONS');
        }, null, 49.68)
        ...
        // Title - animate positioning only
        ...
        .call(() => {
            ...
            console.log('🎯 Animating benefits - NO TEXT OPACITY');
        }, null, 54.96)
        
        // First 3 benefits - ONLY animate containers
        ...
        .call(() => {
            ...
            console.log('🎯 HSA benefits - NO TEXT OPACITY');
        }, null, 64.50)
        
        // HSA and fertility benefits - ONLY animate containers
        ...
        .call(() => {
            ...
            console.log('🎯 Final celebration - NO TEXT OPACITY');
        }, null, 72.37)
        
        // Final celebration - animate containers only
    ...
    console.log('✅ Force visible animation ready!');
    console.log('🎬 Text visibility FORCED with CSS and JS overrides!');
});

console.log('✅ Force visible animation loaded');