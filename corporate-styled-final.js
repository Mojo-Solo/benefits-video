// CORPORATE STYLED FINAL - Professional styling with guaranteed text visibility
console.log('💼 Loading corporate styled final animation...');

window.addEventListener('load', () => {
    console.log('✅ Creating professional styling with visible text...');
    
    // Professional CSS styling that maintains text visibility
    ...
    professionalStyle.textContent = `
        ...
        #scene3::before {
            ...
            background: radial-gradient(circle at 20% 50%, rgba(20, 184, 166, 0.1) 0%, transparent 50%),
                        radial-gradient(circle at 80% 80%, rgba(30, 58, 138, 0.1) 0%, transparent 50%) !important;
        ...
        /* Remove forced borders and backgrounds from debug styles */
        .scene {
        ...
        @media (max-width: 768px) {
            .date { font-size: 1.25rem !important; }
    ...
    // Also set with JavaScript to override any animations
    ...
    // Maintain visibility every 200ms (less frequent than before)
    setInterval(maintainVisibility, 200);
    
    // Initial visibility
    maintainVisibility();
    
    console.log('✅ Professional styling applied with guaranteed text visibility');
});
...
class PerfectTimingAudioManager {
    ...
    initAudio() {
        ...
        console.log('✅ Corporate styled audio initialized');
    }
    ...
    createStartOverlay() {
        ...
        startCard.innerHTML = `
            ...
            <p style="color: rgba(255,255,255,0.8); margin-top: 2rem; font-size: 1rem;">
                ...
                ✨ Professional styling with visible text
            </p>
        `;
    ...
    async startEverything() {
        ...
        console.log('🚀 Starting corporate styled presentation...');
        this.isPlaying = true;
        ...
        if (window.perfectTimeline) {
            ...
            console.log('✅ Corporate styled timeline started');
        }
    }
...
// Main animation with professional styling
window.addEventListener('load', () => {
    console.log('✅ Initializing corporate styled final animation...');
    ...
    timeline
        ...
        // SCENE 2: PROFESSIONALLY STYLED TIMELINE (21.53-49.18s)
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: Timeline intro - PROFESSIONAL STYLING');
        }, null, 21.53)
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: January VO - PROFESSIONAL ANIMATION');
        }, null, 25.40)
        
        // January - smooth professional entrance
        .from(dateGroups[0], {
            x: -60,
            scale: 0.9,
            duration: 1.2,
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: March VO - PROFESSIONAL ANIMATION');
        }, null, 33.87)
        
        // March - smooth professional entrance
        .from(dateGroups[1], {
            x: -60,
            scale: 0.9,
            duration: 1.2,
        ...
        .call(() => {
            ...
            console.log('🗓️ SYNC: December VO - PROFESSIONAL ANIMATION');
        }, null, 41.89)
        
        // December - smooth professional entrance
        .from(dateGroups[2], {
            x: -60,
            scale: 0.9,
            duration: 1.2,
        ...
        // Add subtle hover-like animation
        .to(dateGroups, {
            x: 5,
            duration: 1,
            stagger: 0.2,
        ...
        // SCENE 3: PROFESSIONALLY STYLED BENEFITS (49.68-78.25s)
        .set('#scene3', { 
            opacity: 1, 
            visibility: 'visible',
            display: 'block' 
        ...
        .call(() => {
            ...
            console.log('🎯 Starting Scene 3 - PROFESSIONAL STYLING');
        }, null, 49.68)
        ...
        .call(() => {
            ...
            console.log('🎯 Animating benefits - PROFESSIONAL STYLING');
        }, null, 54.96)
        
        // First 3 benefits - smooth professional entrance
        ...
        .call(() => {
            ...
            console.log('🎯 HSA benefits - PROFESSIONAL STYLING');
        }, null, 64.50)
        
        // HSA and fertility benefits - smooth professional entrance
        ...
        // Highlight HSA with subtle animation
        .to(benefitItems[3], {
            scale: 1.02,
            duration: 0.8,
            yoyo: true,
        ...
        .call(() => {
            ...
            console.log('🎯 Final celebration - PROFESSIONAL STYLING');
        }, null, 72.37)
        
        // Final celebration - subtle professional animation
    ...
    console.log('✅ Corporate styled final animation ready!');
    console.log('🎬 Professional styling with guaranteed text visibility!');
});

console.log('✅ Corporate styled final animation loaded');